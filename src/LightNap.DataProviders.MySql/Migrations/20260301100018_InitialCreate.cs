        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ficat = table.Column<string>(type: "longtext", nullable: true, defaultValue: "DIAMETRU ANTEROPOSTERIOR LOB STING 0 cm, PRERENAL LOB DREPT 0 cm, ECOSTRUCTURA OMOGENA, CONTUR REGULAT, FARA PROCESE LOCALIZATE"),
                    colecist = table.Column<string>(type: "longtext", nullable: true, defaultValue: "PERETI NORMALI, FARA CALCULI"),
                    ...
                    pancreas = table.Column<string>(type: "longtext", nullable: true, defaultValue: "OMOGEN, DIMENSIUNI NORMALE"),
                    splina = table.Column<string>(type: "longtext", nullable: true, defaultValue: "0 cm AX LUNG"),
                    rd = table.Column<string>(type: "longtext", nullable: true, defaultValue: "0 cm AX LUNG, IP 0 cm, FARA CALCULI, FARA DILATATII"),
                    rs = table.Column<string>(type: "longtext", nullable: true, defaultValue: "0 cm AX LUNG, IP 0 cm, FARA CALCULI, FARA DILATATII"),
                    vu = table.Column<string>(type: "longtext", nullable: true, defaultValue: "GOLITA"),
                    prostata = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMALA"),
                    ogi = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMALE"),
                    obs = table.Column<string>(type: "longtext", nullable: true),
                    data = table.Column<DateTime>(type: "datetime2(6)", nullable: true),
                    ora = table.Column<DateTime>(type: "datetime2(6)", nullable: true),
                    medic = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ileon = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Cec = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Ascendent = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Transvers = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Descendent = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Sigmoid = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Rect = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    ...
                    data1 = table.Column<DateTime>(type: "datetime2(6)", nullable: true),
                    ora1 = table.Column<DateTime>(type: "datetime2(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sedare_t = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    medicatie = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    Esofag = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Jonctiune = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
                    Stomac = table.Column<string>(type: "longtext", nullable: true, defaultValue: "NORMAL"),
